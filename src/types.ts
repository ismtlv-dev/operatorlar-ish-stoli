...
export interface SchoolRecord {
  ...
  natija: string;       // "Ko'tarmadi" | "O'chirilgan" | "O'ylab ko'radi" | "Maslahat qiladi" | "Xato raqam" | "Kerak emas" | ""
  izoh: string;         // Izoh
}
...
export type StatusFilter = 'all' | 'Ko\'tarmadi' | 'O\'chirilgan' | 'O\'ylab ko\'radi' | 'Maslahat qiladi' | 'Xato raqam' | 'Kerak emas' | 'Kutilmoqda';
